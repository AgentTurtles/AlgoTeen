...
export default function CodeLabWorkbench() {
  ...
  return (
    <div className="mx-auto max-w-[min(1360px,100%)] space-y-12">
      {loadError ? (
      ...
      <div className="rounded-3xl border border-emerald-100 bg-white/95 shadow-[0_30px_80px_rgba(12,38,26,0.12)]">
        ...
        <div className="grid gap-10 px-6 py-8 lg:grid-cols-[minmax(0,4fr)_minmax(320px,2fr)] xl:grid-cols-[minmax(0,4.5fr)_minmax(320px,2fr)] 2xl:grid-cols-[minmax(0,5fr)_minmax(320px,2fr)]">
          ...
          <div id="strategy">
            <ScrollShadowContainer className="rounded-xl border border-emerald-100 bg-white p-4 shadow-sm">
              <div className="space-y-6">
              <div className="rounded-xl border border-emerald-100 bg-white p-5 shadow-sm">
